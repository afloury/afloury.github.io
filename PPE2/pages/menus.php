...
<table class="calheader">
  <tbody><tr>
    ...
    <td class="center">
		<?php
		//echo date('d-m-Y', strtotime('last monday', strtotime(date('d-m-Y'))));
		$d=date('d', strtotime('last sunday', strtotime(date('d-m-Y'))))+1;
		?>
			Du Lundi <?php echo $d ?> Mai au Vendredi <?php echo $d+4 ?> Mai.
      
      &nbsp;&nbsp;&nbsp;&nbsp;
    </td>
    <td class="right"><a href="index.php?page=menus2">semaine suivante</a> &gt;&gt;</td>
  </tr>
...
<center>
                        <div class="eventlisting">
                          <a href="index.php?page=jour&amp;j=1" onmouseover="mouseOverEvent(1, 1, 'calinfo1event1')" onmouseout="mouseOutEvent(1, 1, 'calinfo1event1')" class="eventPublished">  
...
<center>
                        <div class="eventlisting">
                          <a href="index.php?page=jour&amp;j=2" onmouseover="mouseOverEvent(2, 2, 'calinfo2event1')" onmouseout="mouseOutEvent(2, 2, 'calinfo2event1')" class="eventPublished">  
...
<center>
                        <div class="eventlisting">
                          <a href="index.php?page=jour&amp;j=3" onmouseover="mouseOverEvent(3, 3, 'calinfo3event1')" onmouseout="mouseOutEvent(3, 3, 'calinfo3event1')" class="eventPublished">  
...
<center>
                        <div class="eventlisting">
                          <a href="index.php?page=jour&amp;j=4" onmouseover="mouseOverEvent(4, 4, 'calinfo4event1')" onmouseout="mouseOutEvent(4, 4, 'calinfo4event1')" class="eventPublished">  
...
<center>
                        <div class="eventlisting">
                          <a href="index.php?page=jour&amp;j=5" onmouseover="mouseOverEvent(5, 5, 'calinfo5event1')" onmouseout="mouseOutEvent(5, 5, 'calinfo5event1')" class="eventPublished">  
